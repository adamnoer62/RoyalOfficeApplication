    ...
    <header id="navbar" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-transparent py-4">
        ...
        <div class="container mx-auto px-4 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-8 items-center" id="nav-menu">
                ...
                <a href="#" class="nav-link transition-colors duration-300 text-white hover:text-yellow-500">FAQ</a>
            </nav>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300">
                        <li><a href="#" class="hover:text-yellow-400">Virtual Office</a></li>
                        <li><a href="#" class="hover:text-yellow-400">Ruang Kantor</a></li>
                        <li><a href="#" class="hover:text-yellow-400">Pendirian PT/CV</a></li>
                    </ul>
                </div>
                <div>
