...
@section('content')
    <div class="container mx-auto px-6 py-12">
        <div class="max-w-3xl mx-auto">
            <!-- Card with similar styling to the Blog create form -->
            <div class="bg-white shadow-lg rounded-lg border-t-4 border-gray-300 overflow-hidden">
                <div class="p-8">
                    <h3 class="text-3xl font-semibold text-gray-800 mb-6">Create a New FAQ</h3>
                    ...
                    <form action="{{ route('faqs.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" class="w-full p-4 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 ease-in-out transform hover:scale-105" id="question" name="question" required>
                        </div>

                        <!-- Answer Input -->
                        <div class="mb-6">
                            <label for="answer" class="block text-xl font-medium text-gray-700">Answer</label>
                            <textarea class="w-full p-4 mt-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 ease-in-out transform hover:scale-105" id="answer" name="answer" rows="6" required></textarea>
                        </div>
